...
Since our time was limited we did not write tests for any view \todo{Widget...}{Michael} and the tests on the rest were minimum tests, where we tested expected results on normal behavior and error handling of the errors from the server.
