...
This paper is divided into two primary parts; 1) the implementation of the server including the associated collaboration process and 2) the implementation of the client. \todo{Formatting}{Michael}
