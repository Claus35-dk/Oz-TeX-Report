...
\todo{Add the use cases to the client?}{Nicolai}
\todo{Vælg hvilke use cases som skal smide i appendix.}{Nicolai}
...
\todo{Fjern noget linjemellemrum ved samtlige use cases}{k}
...
\begin{tabbing}
\hspace{5mm}\=\hspace{26mm}\=\kill
\>Primary Actor:\> Customer, Content Provider or Admin\todo{change to un-auth}{k}\\
\>Precondition:\> The actor already has an account.\\
\>Postcondition:\> The actor is logged in.
\end{tabbing}
\begin{enumerate} \setlength{\itemsep}{-1mm}
	\item John Doe click on the "log in" link.
	\item John Doe enters his login information (username/email and password). \todo{Not email}{Michael}
	\item John Doe clicks the "enter" link. \todo{Not enter, login}{Michael}
\end{enumerate}
% % %
\vspace{3mm}
\textbf{Success scenario: Log out} \\
\todo{Remove if not moved to client}{k}
...
\begin{enumerate} \setlength{\itemsep}{-1mm}
	...
	\item He confirms that he will spend 50 credits to rent this product for a week. \todo{We do not confirm}{Michael}
\end{enumerate}
% % %
\vspace{3mm}
...
\begin{enumerate} \setlength{\itemsep}{-1mm}
	...
	\item He confirms that he will spend 100 credits to buy this product. \todo{We do not confirm}{Michael}
\end{enumerate}
% % %
\vspace{3mm}
...
\begin{enumerate} \setlength{\itemsep}{-1mm}
	...
	\item He chooses the media from his local \todo{remove "local"}{k} computer and clicks the "upload" link.
\end{enumerate}
% % %
\vspace{3mm}
...
% % %
\vspace{3mm}
\todo{The next two. We do not confirm, and it is not a link}{Michael}
