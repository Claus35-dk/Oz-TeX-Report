...
The functional requirements for the server is derived from the use cases \todo{Ikke hvis use cases bliver smidt længere ned.}{Nicolai} and the use case diagram. They can be seen in \tref{functionalRequirements}.
