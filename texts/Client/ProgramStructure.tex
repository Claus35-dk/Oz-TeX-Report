...
The next argument in the URI is which method to invoke. In our variation of MVC we invoke the method requested in the modules default controller, which then \todo{Not good formulation}{Michael} is responsible for returning some content to be rendered in form of a widget.
