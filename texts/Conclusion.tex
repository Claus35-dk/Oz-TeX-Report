...
\\\todo{Tilføj mere}{Claus}
\todo{We do not use their names anywhere but here... yet, Michael?}{Philip}

\subsubsubsection{Client}
\todo{The following is an almost exact copy of the Client/Server. What can we do about that?}{Claus}
...
\todo{Remove this section?}{Claus}\\
\todo{I think it should stay}{Morten}\\
